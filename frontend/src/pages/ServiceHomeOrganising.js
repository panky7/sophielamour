      ...
      <section className="py-24 lg:py-32 px-6 md:px-12 lg:px-24">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6 text-base lg:text-lg leading-relaxed text-[#5C5A56] mb-12">
            <div>
              <h3 className="text-xl font-semibold text-[#2C2C2A] mb-2">{t('Votre maison vous semble encombrée ou oppressante ?', 'Does your home feel cluttered or oppressive?')}</h3>
            ...
            <div>
              <h3 className="text-xl font-semibold text-[#2C2C2A] mb-2">{t('Vous avez besoin d’un cadre de vie plus harmonieux ?', 'Do you need a more harmonious living environment?')}</h3>
            ...
            <div>
              <h3 className="text-xl font-semibold text-[#2C2C2A] mb-2">{t('Vous voulez aller à l’essentiel ?', 'Do you want to get to the essentials?')}</h3>
