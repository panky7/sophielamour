      ...
      <section className="py-24 lg:py-32 px-6 md:px-12 lg:px-24">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6 text-base lg:text-lg leading-relaxed text-[#5C5A56] mb-12">
            <div>
              <h3 className="text-xl font-semibold text-[#2C2C2A] mb-2">{t('Vous sentez-vous perdu(e) dans votre vie ?', 'Do you feel lost in your life?')}</h3>
            ...
            <div>
              <h3 className="text-xl font-semibold text-[#2C2C2A] mb-2">{t('Une nouvelle étape s’impose-t-elle à vous ?', 'Is a new stage necessary for you?')}</h3>
            ...
            <div>
              <h3 className="text-xl font-semibold text-[#2C2C2A] mb-2">{t('Vous sentez-vous épuisé(e) ou surmené(e) ?', 'Do you feel exhausted or overwhelmed?')}</h3>
