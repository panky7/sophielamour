      ...
      <section className="py-24 lg:py-32 px-6 md:px-12 lg:px-24">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6 text-base lg:text-lg leading-relaxed text-[#5C5A56] mb-12">
            <div>
              <h3 className="text-xl font-semibold text-[#2C2C2A] mb-2">{t('Vous attendez un enfant ou venez d’accueillir un nouveau-né ?', 'Are you expecting a child or have just welcomed a newborn?')}</h3>
            ...
            <div>
              <h3 className="text-xl font-semibold text-[#2C2C2A] mb-2">{t('Votre enfant traverse une période difficile ?', 'Is your child going through a difficult period?')}</h3>
            ...
            <div>
              <h3 className="text-xl font-semibold text-[#2C2C2A] mb-2">{t('Vous vivez des tensions avec votre adolescent ?', 'Are you experiencing tensions with your teenager?')}</h3>
